<script lang="ts">
    ...
    const inputDisabledClasses = 'disabled:cursor-not-allowed disabled:bg-gray-100 disabled:opacity-70 disabled:dark:bg-gray-600';
    ...
    const buttonLinkDisabledClasses = 'disabled:cursor-not-allowed disabled:text-gray-400 disabled:no-underline';
